...
export class BurnRateUpdated extends ethereum.Event {
  get params(): BurnRateUpdated__Params {
    return new BurnRateUpdated__Params(this);
  }
}

export class BurnRateUpdated__Params {
  _event: BurnRateUpdated;

  constructor(event: BurnRateUpdated) {
    this._event = event;
  }
...
export class MaxTransferAmountRateUpdated extends ethereum.Event {
  get params(): MaxTransferAmountRateUpdated__Params {
    return new MaxTransferAmountRateUpdated__Params(this);
  }
}

export class MaxTransferAmountRateUpdated__Params {
  _event: MaxTransferAmountRateUpdated;

  constructor(event: MaxTransferAmountRateUpdated) {
    this._event = event;
  }
...
export class ViolaToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class ViolaToken extends ethereum.SmartContract {
  static bind(address: Address): ViolaToken {
    return new ViolaToken("ViolaToken", address);
  }
  ...
  _operator(): Address {
    let result = super.call("_operator", "_operator():(address)", []);

    return result[0].toAddress();
  }

  try__operator(): ethereum.CallResult<Address> {
    let result = super.tryCall("_operator", "_operator():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  burnRate(): i32 {
    let result = super.call("burnRate", "burnRate():(uint16)", []);

    return result[0].toI32();
  }

  try_burnRate(): ethereum.CallResult<i32> {
    let result = super.tryCall("burnRate", "burnRate():(uint16)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  checkpoints(param0: Address, param1: BigInt): ViolaToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new ViolaToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<ViolaToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new ViolaToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  isExcludedFromAntiWhale(_account: Address): boolean {
    let result = super.call(
      "isExcludedFromAntiWhale",
      "isExcludedFromAntiWhale(address):(bool)",
  ...
  try_isExcludedFromAntiWhale(_account: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isExcludedFromAntiWhale",
      "isExcludedFromAntiWhale(address):(bool)",
      [ethereum.Value.fromAddress(_account)]
  ...
  try_maxTransferAmount(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "maxTransferAmount",
      "maxTransferAmount():(uint256)",
      []
  ...
  maxTransferAmountRate(): i32 {
    let result = super.call(
      "maxTransferAmountRate",
      "maxTransferAmountRate():(uint16)",
      []
    );
  ...
  try_maxTransferAmountRate(): ethereum.CallResult<i32> {
    let result = super.tryCall(
      "maxTransferAmountRate",
      "maxTransferAmountRate():(uint16)",
      []
...
export class ExcludeFromAntiWhaleCall extends ethereum.Call {
  get inputs(): ExcludeFromAntiWhaleCall__Inputs {
    return new ExcludeFromAntiWhaleCall__Inputs(this);
  }

  get outputs(): ExcludeFromAntiWhaleCall__Outputs {
    return new ExcludeFromAntiWhaleCall__Outputs(this);
  }
}

export class ExcludeFromAntiWhaleCall__Inputs {
  _call: ExcludeFromAntiWhaleCall;

  constructor(call: ExcludeFromAntiWhaleCall) {
    this._call = call;
  }
...
export class ExcludeFromAntiWhaleCall__Outputs {
  _call: ExcludeFromAntiWhaleCall;
...
export class UpdateBurnRateCall extends ethereum.Call {
  get inputs(): UpdateBurnRateCall__Inputs {
    return new UpdateBurnRateCall__Inputs(this);
  }

  get outputs(): UpdateBurnRateCall__Outputs {
    return new UpdateBurnRateCall__Outputs(this);
  }
}

export class UpdateBurnRateCall__Inputs {
  _call: UpdateBurnRateCall;

  constructor(call: UpdateBurnRateCall) {
    this._call = call;
  }
...
export class UpdateBurnRateCall__Outputs {
  _call: UpdateBurnRateCall;
...
export class UpdateMaxTransferAmountRateCall extends ethereum.Call {
  get inputs(): UpdateMaxTransferAmountRateCall__Inputs {
    return new UpdateMaxTransferAmountRateCall__Inputs(this);
  }

  get outputs(): UpdateMaxTransferAmountRateCall__Outputs {
    return new UpdateMaxTransferAmountRateCall__Outputs(this);
  }
}

export class UpdateMaxTransferAmountRateCall__Inputs {
  _call: UpdateMaxTransferAmountRateCall;

  constructor(call: UpdateMaxTransferAmountRateCall) {
    this._call = call;
  }

  get _maxTransferAmountRate(): i32 {
    return this._call.inputValues[0].value.toI32();
  }
}

export class UpdateMaxTransferAmountRateCall__Outputs {
  _call: UpdateMaxTransferAmountRateCall;
